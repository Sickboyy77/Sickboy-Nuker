...
import utilities.Plugins.Account_Sickboy
...
def spammer():
    ...
    Write.Print("                                     /$$__  $$|_  $$_/ /$$__  $$| $$  /$$/| $$__  $$ /$$__  $$|  $$   /$$/\n", Colors.cyan_to_blue, interval=0.000)
    Write.Print("                                    | $$  \__/  | $$  | $$  \__/| $$ /$$/ | $$  \ $$| $$  \ $$ \  $$ /$$/ \n", Colors.cyan_to_blue, interval=0.000)
    Write.Print("                                    |  $$$$$$   | $$  | $$      | $$$$$/  | $$$$$$$ | $$  | $$  \  $$$$/  \n", Colors.cyan_to_blue, interval=0.000)
    Write.Print("                                     \____  $$  | $$  | $$      | $$  $$  | $$__  $$| $$  | $$   \  $$/   \n", Colors.cyan_to_blue, interval=0.000)
    Write.Print(f' > [v1.0.1]                          /$$  \ $$  | $$  | $$    $$| $$\  $$ | $$  \ $$| $$  | $$    | $$    \n', Colors.cyan_to_blue, interval=0.000)
    Write.Print(f' > []                               |  $$$$$$/ /$$$$$$|  $$$$$$/| $$ \  $$| $$$$$$$/|  $$$$$$/    | $$    \n', Colors.cyan_to_blue, interval=0.000)
    Write.Print(" > [https://discord.gg/Z25xw6xg]     \______/ |______/ \______/ |__/  \__/|_______/  \______/     |__/    \n", Colors.cyan_to_blue, interval=0.000)
    Write.Print("╔══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗", Colors.cyan_to_blue, interval=0.000)
    print(f'''{m}'''.replace('$', f'{m}${w}') + f'''
{m}[{w}1{Fore.RESET}{m}]{Fore.RESET} NickName Changer   {b}|{Fore.RESET}{m}[{w}9{Fore.RESET}{m}]{Fore.RESET}  Channel Spammer   {b}|{Fore.RESET}{m}[{w}17{Fore.RESET}{m}]{Fore.RESET} Patch Notes{Fore.RESET}         {b}|{Fore.RESET}{m}[{w}25{Fore.RESET}{m}]{Fore.RESET} R/N{Fore.RESET}
{m}[{w}2{Fore.RESET}{m}]{Fore.RESET} Reaction Spammer   {b}|{Fore.RESET}{m}[{w}10{Fore.RESET}{m}]{Fore.RESET} DM Spammer        {b}|{Fore.RESET}{m}[{w}18{Fore.RESET}{m}]{Fore.RESET} About/Activity{Fore.RESET}      {b}|{Fore.RESET}{m}[{w}26{Fore.RESET}{m}]{Fore.RESET} R/N{Fore.RESET}
{m}[{w}3{Fore.RESET}{m}]{Fore.RESET} VC Spammer         {b}|{Fore.RESET}{m}[{w}11{Fore.RESET}{m}]{Fore.RESET} Friend Spammer    {b}|{Fore.RESET}{m}[{w}19{Fore.RESET}{m}]{Fore.RESET} Nitro Generator{Fore.RESET}     {b}|{Fore.RESET}{m}[{w}27{Fore.RESET}{m}]{Fore.RESET} R/N{Fore.RESET}
{m}[{w}4{Fore.RESET}{m}]{Fore.RESET} Token Onliner      {b}|{Fore.RESET}{m}[{w}12{Fore.RESET}{m}]{Fore.RESET} HypeSquad Joiner  {b}|{Fore.RESET}{m}[{w}20{Fore.RESET}{m}]{Fore.RESET} Token Infomation{Fore.RESET}    {b}|{Fore.RESET}{m}[{w}28{Fore.RESET}{m}]{Fore.RESET} R/N{Fore.RESET}
{m}[{w}5{Fore.RESET}{m}]{Fore.RESET} Token Grabber      {b}|{Fore.RESET}{m}[{w}13{Fore.RESET}{m}]{Fore.RESET} Server Leaver     {b}|{Fore.RESET}{m}[{w}21{Fore.RESET}{m}]{Fore.RESET} Status Changer{Fore.RESET}      {b}|{Fore.RESET}{m}[{w}29{Fore.RESET}{m}]{Fore.RESET} R/N{Fore.RESET}
{m}[{w}6{Fore.RESET}{m}]{Fore.RESET} Auto Login         {b}|{Fore.RESET}{m}[{w}14{Fore.RESET}{m}]{Fore.RESET} Server Joiner     {b}|{Fore.RESET}{m}[{w}22{Fore.RESET}{m}]{Fore.RESET} Group Spammer{Fore.RESET}       {b}|{Fore.RESET}{m}[{w}30{Fore.RESET}{m}]{Fore.RESET} R/N{Fore.RESET}
{m}[{w}7{Fore.RESET}{m}]{Fore.RESET} Account Nuker      {b}|{Fore.RESET}{m}[{w}15{Fore.RESET}{m}]{Fore.RESET} Webhook Spammer   {b}|{Fore.RESET}{m}[{w}23{Fore.RESET}{m}]{Fore.RESET} Server MassDM{Fore.RESET}       {b}|{Fore.RESET}{m}[{w}31{Fore.RESET}{m}]{Fore.RESET}{lr} THREADS{Fore.RESET}
{m}[{w}8{Fore.RESET}{m}]{Fore.RESET} Server Nuker       {b}|{Fore.RESET}{m}[{w}16{Fore.RESET}{m}]{Fore.RESET} Token Checker     {b}|{Fore.RESET}{m}[{w}24{Fore.RESET}{m}]{Fore.RESET} DM Deleter{Fore.RESET}          {b}|{Fore.RESET}{m}[{w}32{Fore.RESET}{m}]{Fore.RESET}{lr} EXIT{Fore.RESET}''')
    Write.Print("╚══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝", Colors.cyan_to_blue, interval=0.000)
...
[\x1b[95m>\x1b[95m\x1B[37m] Choice?: """)
        ...
        if gh in ['01','1']:
            webbrowser.open('https://discord.gg/Z25xw6xg')
        elif gh in ['02','2']:
            exit = spammer()
        else:
         print('')
...
#   TOKEN ONLINER
    if choice == '4':
            ...
            config = {
                ...
                "state": "https://discord.gg/Z25xw6xg",
                "name": "GANG NUKER",
            }
...
#   DM SPAMMER
    if choice == '10':
        ...
        gh = input(f"""
DM Spammer is in the Paid Version
